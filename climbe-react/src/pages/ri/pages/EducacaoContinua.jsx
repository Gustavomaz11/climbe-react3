...
const EducacaoContinua = () => {
  ...
  const fetchData = async (pageToken = null) => {
    try {
      const endpoint = pageToken 
        ? `/api/ri/educacaoContinua?pageToken=${pageToken}`
        : `/api/ri/educacaoContinua`
  ...
  const fetchAllData = async () => {
    try {
      setIsSearching(true)
      const result = await request('/api/ri/educacaoContinua/getAll')
...
export default EducacaoContinua